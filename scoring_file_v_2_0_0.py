...
data_sample = PandasParameterType(pd.DataFrame({"StoreCode": pd.Series([0], dtype="int64"), "StoreCategoryCode": pd.Series([0], dtype="int64"), "ProductId": pd.Series([0], dtype="int64"), "ProductCategoryCode": pd.Series([0], dtype="int64"), "SalesDate": pd.Series(["2000-1-1"], dtype="datetime64[ns]")}), enforce_shape=False)
